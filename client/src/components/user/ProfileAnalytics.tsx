          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="p-4 rounded-lg shadow-md">
                <TaskProgress 
                    ...
                    pending={userAnalysisData.progress.totalTasks - userAnalysisData.progress.overdueTasks -userAnalysisData.progress.completedTasks}
            ...
            <div className=" p-4 rounded-lg shadow-md">
                <PointProgress 
                    ...
                    pointsLost={userAnalysisData.progress.points - userAnalysisData.progress.pointsGained}
